...
public class reWrite01copy {
    public static void main(String[] args) {
        ...
        //返回运行结果
        System.out.println(copy.reWrite01copy.combatConsumeDice(dice, combatSkillNumber, roleCombatSkillDice1, roleCombatSkillDice2, roleCombatSkillDice3, mainRoleNumber));
        System.out.println(Arrays.toString(copy.reWrite01copy.combatConsumeHP(combatSkillNumber, otherHP, mainRoleNumber, roleCombatSkillHurtNumber1, roleCombatSkillHurtNumber2, roleCombatSkillHurtNumber3)));
    }
